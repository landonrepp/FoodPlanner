...
CREATE TABLE `tblIngredients` (
  ...
  `measure` varchar(2000) DEFAULT NULL,
  `ingredient` varchar(2000) DEFAULT NULL,
  PRIMARY KEY (`ingredientID`),
  KEY `recipeID` (`recipeID`),
  CONSTRAINT `tblIngredients_ibfk_1` FOREIGN KEY (`recipeID`) REFERENCES `tblRecipes` (`recipeID`)
) ENGINE=InnoDB AUTO_INCREMENT=13757 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
