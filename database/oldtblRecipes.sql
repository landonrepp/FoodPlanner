...
--
-- Table structure for table `oldtblRecipes`
--

DROP TABLE IF EXISTS `oldtblRecipes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `oldtblRecipes` (
...
) ENGINE=InnoDB AUTO_INCREMENT=11385 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
